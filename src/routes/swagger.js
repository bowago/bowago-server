...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'Complete backend API for the BowaGO shipment tracking and logistics platform.',
    },
    servers: [
      { url: 'http://localhost:5000/api/v1', description: 'Local Development' },
      { url: 'https://bowago-backend.vercel.app/api/v1', description: 'Production' },
    ],
    components: {
      securitySchemes: {
        bearerAuth: {
      ...
      schemas: {
        ...
        User: {
          ...
          properties: {
            ...
            adminSubRole: { type: 'string', enum: ['LOGISTICS_MANAGER', 'SUPER_ADMIN'], nullable: true },
        ...
        TrackingEvent: {
          ...
          properties: {
            ...
            description: { type: 'string', example: 'Package arrived at sorting facility' },
        ...
        Notification: {
          ...
          properties: {
            id: { type: 'string', format: 'uuid' },
            type: { type: 'string', enum: ['SHIPMENT_UPDATE','PAYMENT','PROMO','SYSTEM'] },
            title: { type: 'string', example: 'Shipment BG-20260311-XYZ12' },
            body: { type: 'string', example: 'Your shipment is now in transit' },
