...
All monetary values are stored in **Kobo** internally. API responses include computed \`amountNaira\` fields for display.
    ...
    tags: [
      ...
      {
        name: "Contract Rates",
        description: "Sprint 2 — B2B enterprise rate cards",
      },
      {
        name: "Promo Codes",
        description: "Sprint 2 — Promotional discount codes",
      },
      {
        name: "Policies & Guides",
        description:
          "Sprint 2 Story 9.4 + Sprint 5 Story 11.5 — T&C, policies, packaging guide",
      },
    ],
    components: {
      securitySchemes: {
      ...
      schemas: {
        ...
        ContractRate: {
          type: "object",
          description:
            "Sprint 2 — B2B enterprise rate card. Overrides standard pricing for an enterprise client.",
          properties: {
            id: { type: "string", format: "uuid" },
            userId: { type: "string", format: "uuid" },
            label: {
              type: "string",
              example: "Dangote Group — Annual Contract",
              nullable: true,
            },
            serviceType: {
              type: "string",
            ...
            discountPercent: {
              ...
              example: 15,
              nullable: true,
              description: "Percentage off standard rate",
            },
            fixedPricePerKgByZone: {
              ...
              description:
                "Fixed NGN/kg price per zone. Overrides price band entirely.",
            },
            isActive: { type: "boolean" },
        ...
        PromoCode: {
          type: "object",
          description:
            "Sprint 2 — Promotional discount code. Applied when user has no contract rate.",
          properties: {
            id: { type: "string", format: "uuid" },
        ...
        PolicyContent: {
          type: "object",
          description:
            "Sprint 2 Story 9.4 — Legal policy content (T&C, Refund Policy, Pricing Policy). Shown at quote and payment screens.",
          properties: {
            id: { type: "string", format: "uuid" },
            key: {
              type: "string",
              ...
              description:
                "terms_of_service | refund_policy | pricing_policy | liability | privacy_policy",
            },
            title: { type: "string", example: "Terms of Service" },
            body: {
              type: "string",
              description: "Markdown or HTML content rendered on the frontend",
            },
            isActive: { type: "boolean" },
            updatedAt: { type: "string", format: "date-time" },
          },
        ...
        PackagingGuide: {
          type: "object",
          description:
            "Sprint 5 Story 11.5 — Packaging instructions and dangerous goods rules. Accessible within 2 clicks from booking confirmation.",
          properties: {
            id: { type: "string", format: "uuid" },
            title: { type: "string", example: "How to Pack Fragile Items" },
            body: {
              type: "string",
              description: "Markdown content with packaging instructions",
            },
            category: {
              type: "string",
              enum: [
            ...
            imageUrl: {
              type: "string",
              nullable: true,
              description: "Cloudinary URL for illustration",
            },
            sortOrder: { type: "integer", example: 0 },
            isDangerous: {
              type: "boolean",
              description:
                "true = this is a dangerous goods rule — shown prominently",
            },
            isActive: { type: "boolean" },
            createdAt: { type: "string", format: "date-time" },
          },
